...
export function OrderSummary({
  ...
  const totalDiscountAmount = (activeOrder?.discounts || []).reduce(
    (sum: number, d: any) => sum + Math.abs(d.amountWithTax),
    0,
  );
  ...
  return (
    <div className="p-4 lg:p-6 lg:sticky lg:top-4 h-auto lg:h-full border border-karima-brand/10 lg:border-none rounded-sm lg:rounded-none">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="text-karima-ink/60 underline underline-offset-4 text-sm">
          {" "}
          ...
          {lines.map((line) => (
            <div key={line.id} className="flex gap-4">
              ...
              <div className="w-20 h-20 flex-shrink-0 bg-gray-100 rounded-sm overflow-hidden">
                {getVariantImagePreview(line.productVariant, line.featuredAsset) ? (
                  <img
                    src={getVariantImagePreview(line.productVariant, line.featuredAsset) + "?preset=medium"}
      ...
      <div className="space-y-3 font-sans text-karima-ink">
        ...
        <div className="flex justify-between items-center text-base">
          ...
          <span className="font-medium">
            <Price
              priceWithTax={subTotal + totalDiscountAmount}
              currencyCode={currencyCode}
            />
          </span>
        </div>
        ...
        {totalDiscountAmount > 0 && (
          <div className="flex justify-between items-center text-base text-green-600">
            ...
            <span className="font-medium">
              -{" "}
              <Price
                priceWithTax={totalDiscountAmount}
                currencyCode={currencyCode}
              />
            </span>
          </div>
        ...
        <div className="flex justify-between items-center text-base">
          ...
          <span className="font-medium">
            {shippingCost > 0 ? (
              ...
              <span className="text-karima-ink/60 text-sm">

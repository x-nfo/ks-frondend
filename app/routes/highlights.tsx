        ...
        <div className="min-h-screen pt-40 md:pt-52 pb-24 bg-white relative">
            ...
            <div className="container mx-auto max-w-5xl px-6">
                <div className="text-center mb-16">
                    ...
                    >
                        Stay updated with our latest collections, limited edition releases, and upcoming product drops.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-16 mb-24">
                    ...
                    <div className="group cursor-pointer">
                        ...
                        <p className="text-karima-ink/60 font-light text-sm leading-relaxed mb-6">
                            Inspired by the ancient city, this collection features earthy tones, flowing silhouettes, and intricate embroidery.
                        </p>
                        <Link to="/collections/medina" className="text-xs uppercase tracking-widest text-karima-brand border-b border-karima-brand/30 pb-1 hover:border-karima-brand transition-all">
                            Explore Collection
                        </Link>
                    </div>
                    ...
                    <div className="group cursor-pointer">
                        ...
                        <p className="text-karima-ink/60 font-light text-sm leading-relaxed mb-6">
                            A curated selection of luxurious abayas designed specifically for the festive season. Limited quantities available.
                        </p>
                        <Link to="/collections/eid-exclusive" className="text-xs uppercase tracking-widest text-karima-brand border-b border-karima-brand/30 pb-1 hover:border-karima-brand transition-all">
                            View Lookbook
                        </Link>
                    </div>
                </div>
                ...
                <div className="bg-karima-base/50 p-12 text-center border border-karima-brand/5">
                    <Calendar size={32} strokeWidth={1} className="mx-auto text-karima-gold mb-6" />
                    <h3 className="text-2xl font-serif text-karima-brand italic mb-4">Upcoming Drop</h3>
                    <p className="text-karima-ink/70 font-light mb-2">October 15, 2025</p>
                    <p className="text-lg font-medium text-karima-brand uppercase tracking-widest">Midnight Velvet Series</p>
                </div>
            </div>
        </div>
    );

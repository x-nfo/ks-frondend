...
export function ShippingAddressSelector({
    ...
    return (
        <RadioGroup value={selectedAddressIndex} onChange={onChange} className="space-y-4">
                            ...
                            <>
                                <div className="flex w-full items-start gap-3">
                                    <div className={clsx(
                                        ...
                                        checked ? "bg-karima-brand/10 text-karima-brand" : "bg-gray-100 text-gray-400 group-hover:bg-gray-200"
                                    )}>
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="text-xs text-karima-ink/60 space-y-1 font-medium font-sans">
                                            ...
                                            <p>{address.postalCode}, {address.country.name}</p>
                                        </div>
                                    </div>
                                </div>
                            </>

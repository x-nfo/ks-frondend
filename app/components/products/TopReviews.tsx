              ...
              <DisclosurePanel className="pb-10 animate-fadeIn">
                  ...
                  <div className="mb-12 grid grid-cols-1 lg:grid-cols-12 gap-12 border-b border-karima-brand/10 pb-12">
                    <div className="lg:col-span-4 flex flex-col justify-center">
                      <div className="flex items-baseline gap-4">
                        <span className="text-6xl font-serif text-karima-brand">
                      ...
                      <p className="mt-2 text-sm text-karima-brand/60">
                      ...
                      {[5, 4, 3, 2, 1].map((rating) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="ml-4 w-10 text-right text-karima-brand/60">
                              ({count})
                            </div>
                          </div>
                        );
                ...
                <TabGroup>
                  <TabList className="flex space-x-8 border-b border-karima-brand/10 mb-8">
                    ...
                    >
                      Reviews{" "}
                      <span className="ml-1 text-[10px] align-top opacity-60 bg-karima-brand/5 px-1.5 py-0.5 rounded-full">
                        {totalReviews}
                      </span>
                    </Tab>
                  </TabList>
                          ...
                          <div className="flex flex-col items-center justify-center space-y-4">
                            <div className="flex gap-1">
                              {[1, 2, 3, 4, 5].map((star) => (
                                <StarOutlineIcon
                                  key={star}
                                  className="h-5 w-5 text-karima-brand/20"
                                />
                              ))}
                            </div>
                          ...
                          {reviews.map((review) => (
                            ...
                            >
                              ...
                              <div className="flex justify-between items-center text-sm">
                                <h4 className="font-bold text-karima-brand uppercase tracking-wide text-xs">
                                  {review.authorName}
                                </h4>
                                <time

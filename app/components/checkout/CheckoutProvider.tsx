...
import type { Order, ShippingMethod, PaymentMethod, Customer } from '~/generated/graphql';
...
export function CheckoutProvider({
    ...
    const completeStep = (step: CheckoutStep) => {
        ...
        // Auto-advance
        const orderNodes: CheckoutStep[] = ['contact', 'address', 'delivery', 'payment'];
    ...
    useEffect(() => {
        ...
        if (activeOrder?.shippingAddress?.streetLine1 && !completedSteps.has('address')) {

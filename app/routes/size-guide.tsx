      ...
      <div className="container mx-auto max-w-4xl px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-karima-ink/60 font-light max-w-lg mx-auto leading-relaxed">
            Use this chart to find your perfect fit. Our abayas are designed to
            be loose and modest.
          </p>
        </div>
        ...
        <div className="overflow-x-auto mb-16 border border-karima-brand/10">
          <table className="w-full text-center text-sm">
            <thead className="bg-karima-brand/5 text-karima-brand uppercase tracking-widest font-medium">
              <tr>
                <th className="py-4 px-6 border-b border-karima-brand/10">
                  Size
                </th>
                <th className="py-4 px-6 border-b border-karima-brand/10">
                  Bust (cm)
        ...
        <div className="bg-karima-base/30 p-8 flex items-start gap-6 border border-karima-brand/5">
          <Ruler
            size={32}
            strokeWidth={1}
            className="text-karima-gold shrink-0 mt-1"
          />
          <div>
            <h3 className="font-serif text-xl text-karima-brand italic mb-2">
              Measuring Tips
            </h3>
            <ul className="text-karima-ink/70 font-light text-sm space-y-2 list-disc pl-4">
              ...
              <li>
                <strong>Length:</strong> Measure from the highest point of your
                shoulder down to the floor.
              </li>
            </ul>
          </div>
        </div>

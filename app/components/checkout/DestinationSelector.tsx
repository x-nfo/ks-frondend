                ...
                {isLoading ? (
                  <div className="relative cursor-default select-none py-4 px-6 text-gray-500">
                    <div className="flex items-center gap-3">
                      <svg
                        className="animate-spin h-5 w-5 text-karima-brand"
                        fill="none"
                        viewBox="0 0 24 24"
                      >
                        <circle
                    ...
                    <ComboboxOption
                      ...
                      className={({ active }) =>
                        clsx(
                          ...
                          active
                            ? "bg-karima-brand/5"
                            : "text-karima-ink border-b border-gray-50 last:border-0",
                        )
                      }
                    >
                      {({ active, selected }) => (
                          ...
                          <div className="flex flex-col">
                            <span
                              className={clsx(
                                ...
                                selected
                                  ? "font-black text-karima-brand"
                                  : "font-bold text-karima-ink",
                              )}
                            >

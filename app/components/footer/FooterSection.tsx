  ...
  return (
    <div className="border-b border-white/5 md:border-none last:border-0">
      ...
      >
        ...
        <svg
          className={`w-4 h-4 text-karima-gold transition-transform duration-300 md:hidden opacity-60 ${
            isOpen ? "rotate-180" : ""
          }`}
          fill="none"
          stroke="currentColor"
      ...
      <div
        id={`${id}-content`}
        className={`overflow-hidden transition-all duration-500 ease-in-out md:max-h-none md:opacity-100 md:overflow-visible md:mt-8 ${
          isOpen
            ? "max-h-[500px] opacity-100 mt-4 pb-6"

      ...
      <div className="container mx-auto max-w-5xl px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-karima-ink/60 font-light max-w-2xl mx-auto leading-relaxed text-lg">
            Connect with like-minded women who value modesty, elegance, and
            faith. Share your style, your stories, and your journey with us.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-12 text-center mb-24">
          <div className="p-8 border border-karima-brand/5 hover:border-karima-brand/20 transition-colors">
            ...
            <p className="text-karima-ink/70 font-light text-sm leading-relaxed">
              Join exclusive gatherings, workshops, and intimate tea sessions
              designed to nurture our sisterhood.
            </p>
          </div>
          <div className="p-8 border border-karima-brand/5 hover:border-karima-brand/20 transition-colors">
            <div className="w-16 h-16 bg-karima-gold/10 rounded-full flex items-center justify-center mx-auto mb-6 text-karima-gold">
            ...
            <p className="text-karima-ink/70 font-light text-sm leading-relaxed">
              Participate in our charitable initiatives. Every purchase
              contributes to education programs for underprivileged children.
            </p>
          </div>
          <div className="p-8 border border-karima-brand/5 hover:border-karima-brand/20 transition-colors">
            <div className="w-16 h-16 bg-karima-gold/10 rounded-full flex items-center justify-center mx-auto mb-6 text-karima-gold">
            ...
            <p className="text-karima-ink/70 font-light text-sm leading-relaxed">
              Tag us in your photos for a chance to be featured on our journal

...
export default function ReviewForm({
  ...
  if (isSuccess || (existingReview && !isSubmitting && !isEditing)) {
    ...
    const isPending =
      reviewToShow?.state === "new" || reviewToShow?.state === "Pending"; // Adjust based on actual state values
        ...
        >
          ...
          {reviewToShow && (
            <div className="mt-4 pt-4 border-t border-black/5">
              ...
              <p className="mt-1 text-gray-600 text-sm font-sans">
                {reviewToShow.body}
              </p>
            </div>
          )}

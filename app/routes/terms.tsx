      ...
      <div className="container mx-auto max-w-3xl px-6">
        ...
        <div className="prose prose-stone max-w-none text-karima-ink/70 font-light leading-relaxed">
          <p>
            ...
            conditions. Do not continue to use Karima if you do not agree to
            take all of the terms and conditions stated on this page.
          </p>

          <h3>1. Intellectual Property Rights</h3>
          <p>
            Other than the content you own, under these Terms, Karima and/or its
          ...
          <p>
            ...
            Karima a non-exclusive, worldwide irrevocable, sub licensable
          ...
          <p>
            This Website is provided "as is," with all faults, and Karima
          ...
          <p>
            In no event shall Karima, nor any of its officers, directors and
            ...
            under contract. Karima, including its officers, directors and
          ...
          <p>
            ...
            the laws of the State of Indonesia, and you submit to the
            non-exclusive jurisdiction of the state and federal courts located
            in Indonesia for the resolution of any disputes.
          </p>
        </div>
      </div>
    </div>

    ...
    <section className="py-12 mt-8 lg:mt-16">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="flex justify-between items-end mb-8 px-2">
          <div>
            <span className="text-[10px] text-karima-accent uppercase tracking-[0.25em] font-bold block mb-2">
              Complete The Look
            </span>
            <h3 className="text-2xl md:text-3xl font-serif text-karima-brand italic">
              You Might Also Like
            </h3>
          </div>
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1 text-center md:text-left">
        <h4 className="font-serif text-base text-karima-brand">
          {product.productName}
        </h4>

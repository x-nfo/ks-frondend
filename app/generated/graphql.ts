...
export type AddressCustomFields = {
  ...
  rajaOngkirDestinationId?: Maybe<Scalars['String']['output']>;
};
...
export type CreateAddressCustomFieldsInput = {
  rajaOngkirDestinationId?: InputMaybe<Scalars['String']['input']>;
};
...
export type CustomerFilterParameter = {
  ...
  rajaOngkirDestinationId?: InputMaybe<StringOperators>;
...
export type CustomerSortParameter = {
  ...
  rajaOngkirDestinationId?: InputMaybe<SortOrder>;
...
export type FeaturedCollection = Node & {
...
export type MidtransClientConfig = {
  __typename?: 'MidtransClientConfig';
...
export type MidtransPaymentDetails = {
  __typename?: 'MidtransPaymentDetails';
  /** E-Wallet actions (deeplink, QR, etc) */
  actions?: Maybe<Array<MidtransAction>>;
  /** Mandiri Bill Payment */
  billKey?: Maybe<Scalars['String']['output']>;
  billerCode?: Maybe<Scalars['String']['output']>;
  ...
  permataVaNumber?: Maybe<Scalars['String']['output']>;
  /** QRIS string for QR code generation */
  qrString?: Maybe<Scalars['String']['output']>;
  /** Credit card redirect URL for 3DS */
  redirectUrl?: Maybe<Scalars['String']['output']>;
  settlementTime?: Maybe<Scalars['String']['output']>;
  store?: Maybe<Scalars['String']['output']>;
  transactionId: Scalars['String']['output'];
  transactionStatus: Scalars['String']['output'];
  /** Virtual Account numbers for bank transfer */
  vaNumbers?: Maybe<Array<MidtransVaNumber>>;
};

export type MidtransPaymentStatus = {
  __typename?: 'MidtransPaymentStatus';
  /** Midtrans payment metadata as JSON string */
  metadata?: Maybe<Scalars['String']['output']>;
  /** Vendure payment state: Authorized, Settled, Declined, Cancelled, etc. */
  state: Scalars['String']['output'];
};

export type MidtransTransactionStatus = {
  __typename?: 'MidtransTransactionStatus';
  fraudStatus?: Maybe<Scalars['String']['output']>;
  grossAmount: Scalars['String']['output'];
  orderId: Scalars['String']['output'];
  paymentType: Scalars['String']['output'];
...
export type MidtransVaNumber = {
  __typename?: 'MidtransVaNumber';
  bank: Scalars['String']['output'];
  vaNumber: Scalars['String']['output'];
};
...
export type Query = {
  ...
  activeFeaturedCollections: Array<FeaturedCollection>;
  activeHeroBanners: Array<HeroBanner>;
  /**
  ...
  activePopup?: Maybe<PopupBanner>;
  activePromoBanners: Array<PromoBanner>;
  ...
  /** Get payment data and Vendure payment state for an order */
  midtransPaymentData?: Maybe<MidtransPaymentStatus>;
  /** Get transaction status from Midtrans */
  midtransTransactionStatus?: Maybe<MidtransTransactionStatus>;
  ...
  /** Daftar kurir yang tersedia/diaktifkan */
  rajaOngkirAvailableCouriers: Array<RajaOngkirCourier>;
  /** Hitung ongkos kirim ke destinasi tertentu */
  rajaOngkirCalculateShipping: Array<RajaOngkirShippingOption>;
  /**
   * Cari destinasi pengiriman berdasarkan kata kunci
   * (nama kota, kecamatan, kelurahan, atau kode pos)
   */
  rajaOngkirSearchDestinations: Array<RajaOngkirDestination>;
...
export type QueryMidtransPaymentDataArgs = {
  orderCode: Scalars['String']['input'];
};


export type QueryMidtransTransactionStatusArgs = {
...
export type QueryRajaOngkirCalculateShippingArgs = {
  destinationId: Scalars['Int']['input'];
  weight: Scalars['Int']['input'];
};


export type QueryRajaOngkirSearchDestinationsArgs = {
...
/** Informasi kurir yang tersedia */
export type RajaOngkirCourier = {
  __typename?: 'RajaOngkirCourier';
  code: Scalars['String']['output'];
  description: Scalars['String']['output'];
  name: Scalars['String']['output'];
};

/** Destinasi pengiriman domestik dari RajaOngkir */
export type RajaOngkirDestination = {
  __typename?: 'RajaOngkirDestination';
  cityName: Scalars['String']['output'];
  districtName: Scalars['String']['output'];
  id: Scalars['Int']['output'];
  label: Scalars['String']['output'];
  provinceName: Scalars['String']['output'];
  subdistrictName: Scalars['String']['output'];
  zipCode: Scalars['String']['output'];
};

/** Opsi pengiriman yang tersedia */
export type RajaOngkirShippingOption = {
  __typename?: 'RajaOngkirShippingOption';
  /** Biaya pengiriman dalam Rupiah (bukan cents) */
  cost: Scalars['Int']['output'];
  courierCode: Scalars['String']['output'];
...
export type SiteSettings = {
  ...
  countdownDate?: Maybe<Scalars['DateTime']['output']>;
  customFields?: Maybe<Scalars['JSON']['output']>;
...
export type UpdateCustomerMutation = { __typename?: 'Mutation', updateCustomer: { __typename?: 'Customer', id: string, firstName: string, lastName: string, phoneNumber?: string | null, title?: string | null } };
...
export type AddPaymentToOrderMutation = { __typename?: 'Mutation', addPaymentToOrder:
    ...
    | { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shippingWithTax: any, totalWithTax: any, couponCodes: Array<string>, shipping: any, payments?: Array<{ __typename?: 'Payment', transactionId?: string | null, metadata?: any | null, id: string, state: string, method: string, amount: any }> | null, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, discounts: Array<{ __typename?: 'Discount', description: string, amountWithTax: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', rajaOngkirDestinationId?: string | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', rajaOngkirDestinationId?: string | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, name: string, description: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, unitPriceWithTax: any, linePriceWithTax: any, quantity: number, proratedUnitPriceWithTax: any, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, productVariant: { __typename?: 'ProductVariant', id: string, name: string, price: any, options: Array<{ __typename?: 'ProductOption', id: string, code: string, name: string, group: { __typename?: 'ProductOptionGroup', id: string, code: string, name: string } }>, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, assets: Array<{ __typename?: 'Asset', id: string, preview: string }>, product: { __typename?: 'Product', id: string, slug: string, assets: Array<{ __typename?: 'Asset', id: string, preview: string }> } }, discounts: Array<{ __typename?: 'Discount', description: string, amountWithTax: any }> }> }
...
export type TransitionOrderToStateMutation = { __typename?: 'Mutation', transitionOrderToState?:
    | { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shippingWithTax: any, totalWithTax: any, couponCodes: Array<string>, shipping: any, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, discounts: Array<{ __typename?: 'Discount', description: string, amountWithTax: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', rajaOngkirDestinationId?: string | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', rajaOngkirDestinationId?: string | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, name: string, description: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, unitPriceWithTax: any, linePriceWithTax: any, quantity: number, proratedUnitPriceWithTax: any, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, productVariant: { __typename?: 'ProductVariant', id: string, name: string, price: any, options: Array<{ __typename?: 'ProductOption', id: string, code: string, name: string, group: { __typename?: 'ProductOptionGroup', id: string, code: string, name: string } }>, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, assets: Array<{ __typename?: 'Asset', id: string, preview: string }>, product: { __typename?: 'Product', id: string, slug: string, assets: Array<{ __typename?: 'Asset', id: string, preview: string }> } }, discounts: Array<{ __typename?: 'Discount', description: string, amountWithTax: any }> }>, payments?: Array<{ __typename?: 'Payment', id: string, state: string, method: string, amount: any, transactionId?: string | null, metadata?: any | null }> | null }
    | { __typename?: 'OrderStateTransitionError', errorCode: ErrorCode, message: string }
   | null };

export type MidtransClientConfigQueryVariables = Exact<{ [key: string]: never; }>;


export type MidtransClientConfigQuery = { __typename?: 'Query', midtransClientConfig: { __typename?: 'MidtransClientConfig', clientKey: string, isProduction: boolean, merchantId?: string | null } };

export type RajaOngkirSearchDestinationsQueryVariables = Exact<{
  search: Scalars['String']['input'];
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
}>;
...
export type RajaOngkirSearchDestinationsQuery = { __typename?: 'Query', rajaOngkirSearchDestinations: Array<{ __typename?: 'RajaOngkirDestination', id: number, label: string, provinceName: string, cityName: string, districtName: string, subdistrictName: string, zipCode: string }> };

export type RajaOngkirCalculateShippingQueryVariables = Exact<{
  destinationId: Scalars['Int']['input'];
  weight: Scalars['Int']['input'];
}>;


export type RajaOngkirCalculateShippingQuery = { __typename?: 'Query', rajaOngkirCalculateShipping: Array<{ __typename?: 'RajaOngkirShippingOption', id: string, courierCode: string, courierName: string, service: string, description: string, cost: number, etd: string }> };

export type RajaOngkirAvailableCouriersQueryVariables = Exact<{ [key: string]: never; }>;


export type RajaOngkirAvailableCouriersQuery = { __typename?: 'Query', rajaOngkirAvailableCouriers: Array<{ __typename?: 'RajaOngkirCourier', code: string, name: string, description: string }> };

export type MidtransTransactionStatusQueryVariables = Exact<{
  transactionId: Scalars['String']['input'];
}>;


export type MidtransTransactionStatusQuery = { __typename?: 'Query', midtransTransactionStatus?: { __typename?: 'MidtransTransactionStatus', transactionId: string, orderId: string, transactionStatus: string, fraudStatus?: string | null, paymentType: string, grossAmount: string, settlementTime?: string | null } | null };
...
export type RemoveCouponCodeMutation = { __typename?: 'Mutation', removeCouponCode?: { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shippingWithTax: any, totalWithTax: any, couponCodes: Array<string>, shipping: any, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, discounts: Array<{ __typename?: 'Discount', description: string, amountWithTax: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', rajaOngkirDestinationId?: string | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', rajaOngkirDestinationId?: string | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, name: string, description: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, unitPriceWithTax: any, linePriceWithTax: any, quantity: number, proratedUnitPriceWithTax: any, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, productVariant: { __typename?: 'ProductVariant', id: string, name: string, price: any, options: Array<{ __typename?: 'ProductOption', id: string, code: string, name: string, group: { __typename?: 'ProductOptionGroup', id: string, code: string, name: string } }>, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, assets: Array<{ __typename?: 'Asset', id: string, preview: string }>, product: { __typename?: 'Product', id: string, slug: string, assets: Array<{ __typename?: 'Asset', id: string, preview: string }> } }, discounts: Array<{ __typename?: 'Discount', description: string, amountWithTax: any }> }>, payments?: Array<{ __typename?: 'Payment', id: string, state: string, method: string, amount: any, transactionId?: string | null, metadata?: any | null }> | null } | null };
...
export type ActiveCustomerOrderListQuery = { __typename?: 'Query', activeCustomer?: { __typename?: 'Customer', orders: { __typename?: 'OrderList', totalItems: number, items: Array<{ __typename?: 'Order', id: string, code: string, state: string, orderPlacedAt?: any | null, currencyCode: CurrencyCode, subTotal: any, subTotalWithTax: any, total: any, totalWithTax: any, shippingWithTax: any, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any }>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', taxBase: any, taxTotal: any }>, discounts: Array<{ __typename?: 'Discount', amountWithTax: any }>, fulfillments?: Array<{ __typename?: 'Fulfillment', id: string, trackingCode?: string | null }> | null, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, discountedLinePriceWithTax: any, discountedUnitPriceWithTax: any, fulfillmentLines?: Array<{ __typename?: 'FulfillmentLine', quantity: number, fulfillment: { __typename?: 'Fulfillment', id: string, state: string, updatedAt: any } }> | null, featuredAsset?: { __typename?: 'Asset', name: string, source: string, preview: string } | null, productVariant: { __typename?: 'ProductVariant', name: string, sku: string, currencyCode: CurrencyCode, priceWithTax: any, product: { __typename?: 'Product', slug: string } } }> }> } } | null };

export type GetActiveHomepageDataQueryVariables = Exact<{ [key: string]: never; }>;


export type GetActiveHomepageDataQuery = { __typename?: 'Query', activeHeroBanners: Array<{ __typename?: 'HeroBanner', id: string, imageUrl: string, headline: string, subtitle: string, ctaText: string, ctaLink: string, sortOrder: number }>, activePromoBanners: Array<{ __typename?: 'PromoBanner', id: string, imageUrl: string, title: string, description?: string | null, linkUrl?: string | null, sortOrder: number }>, activeFeaturedCollections: Array<{ __typename?: 'FeaturedCollection', id: string, collectionId: string, sortOrder: number }>, activePopup?: { __typename?: 'PopupBanner', id: string, imageUrl: string, title: string, linkUrl?: string | null, frequency: string, delay: number } | null };
...
export type SubscribeToNewsletterMutation = { __typename?: 'Mutation', subscribeToNewsletter: { __typename?: 'NewsletterSubscription', id: string, email: string, isVerified: boolean } };

export type ExtendedOrderDetailFragment = { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shippingWithTax: any, totalWithTax: any, couponCodes: Array<string>, shipping: any, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, discounts: Array<{ __typename?: 'Discount', description: string, amountWithTax: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', rajaOngkirDestinationId?: string | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', rajaOngkirDestinationId?: string | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, name: string, description: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, unitPriceWithTax: any, linePriceWithTax: any, quantity: number, proratedUnitPriceWithTax: any, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, productVariant: { __typename?: 'ProductVariant', id: string, name: string, price: any, options: Array<{ __typename?: 'ProductOption', id: string, code: string, name: string, group: { __typename?: 'ProductOptionGroup', id: string, code: string, name: string } }>, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, assets: Array<{ __typename?: 'Asset', id: string, preview: string }>, product: { __typename?: 'Product', id: string, slug: string, assets: Array<{ __typename?: 'Asset', id: string, preview: string }> } }, discounts: Array<{ __typename?: 'Discount', description: string, amountWithTax: any }> }>, payments?: Array<{ __typename?: 'Payment', id: string, state: string, method: string, amount: any, transactionId?: string | null, metadata?: any | null }> | null };

export type ActiveOrderQueryVariables = Exact<{ [key: string]: never; }>;


export type ActiveOrderQuery = { __typename?: 'Query', activeOrder?: { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shippingWithTax: any, totalWithTax: any, couponCodes: Array<string>, shipping: any, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, discounts: Array<{ __typename?: 'Discount', description: string, amountWithTax: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', rajaOngkirDestinationId?: string | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', rajaOngkirDestinationId?: string | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, name: string, description: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, unitPriceWithTax: any, linePriceWithTax: any, quantity: number, proratedUnitPriceWithTax: any, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, productVariant: { __typename?: 'ProductVariant', id: string, name: string, price: any, options: Array<{ __typename?: 'ProductOption', id: string, code: string, name: string, group: { __typename?: 'ProductOptionGroup', id: string, code: string, name: string } }>, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, assets: Array<{ __typename?: 'Asset', id: string, preview: string }>, product: { __typename?: 'Product', id: string, slug: string, assets: Array<{ __typename?: 'Asset', id: string, preview: string }> } }, discounts: Array<{ __typename?: 'Discount', description: string, amountWithTax: any }> }>, payments?: Array<{ __typename?: 'Payment', id: string, state: string, method: string, amount: any, transactionId?: string | null, metadata?: any | null }> | null } | null };
...
export type DetailedProductFragment = { __typename?: 'Product', id: string, name: string, slug: string, description: string, collections: Array<{ __typename?: 'Collection', id: string, slug: string, name: string, breadcrumbs: Array<{ __typename?: 'CollectionBreadcrumb', id: string, name: string, slug: string }> }>, optionGroups: Array<{ __typename?: 'ProductOptionGroup', id: string, code: string, name: string }>, facetValues: Array<{ __typename?: 'FacetValue', id: string, code: string, name: string, facet: { __typename?: 'Facet', id: string, code: string, name: string } }>, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, assets: Array<{ __typename?: 'Asset', id: string, preview: string }>, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string, priceWithTax: any, currencyCode: CurrencyCode, sku: string, stockLevel: string, options: Array<{ __typename?: 'ProductOption', id: string, code: string, name: string, group: { __typename?: 'ProductOptionGroup', id: string, code: string, name: string } }>, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, assets: Array<{ __typename?: 'Asset', id: string, preview: string }> }> };
...
export type ProductQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, name: string, slug: string, description: string, collections: Array<{ __typename?: 'Collection', id: string, slug: string, name: string, breadcrumbs: Array<{ __typename?: 'CollectionBreadcrumb', id: string, name: string, slug: string }> }>, optionGroups: Array<{ __typename?: 'ProductOptionGroup', id: string, code: string, name: string }>, facetValues: Array<{ __typename?: 'FacetValue', id: string, code: string, name: string, facet: { __typename?: 'Facet', id: string, code: string, name: string } }>, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, assets: Array<{ __typename?: 'Asset', id: string, preview: string }>, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string, priceWithTax: any, currencyCode: CurrencyCode, sku: string, stockLevel: string, options: Array<{ __typename?: 'ProductOption', id: string, code: string, name: string, group: { __typename?: 'ProductOptionGroup', id: string, code: string, name: string } }>, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, assets: Array<{ __typename?: 'Asset', id: string, preview: string }> }> } | null };

export type ListedProductFragment = { __typename?: 'SearchResult', productId: string, productName: string, slug: string, currencyCode: CurrencyCode, facetValueIds: Array<string>, productVariantId: string, productAsset?: { __typename?: 'SearchResultAsset', id: string, preview: string } | null, productVariantAsset?: { __typename?: 'SearchResultAsset', id: string, preview: string } | null, priceWithTax:
...
export type ProductReviewFragment = { __typename?: 'ProductReview', id: string, createdAt: any, rating: number, summary: string, body: string, state: string, authorName: string };
...
export type ProductReviewsQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, reviews: Array<{ __typename?: 'ProductReview', id: string, createdAt: any, rating: number, summary: string, body: string, state: string, authorName: string }> } | null };
...
export type SubmitReviewMutation = { __typename?: 'Mutation', submitReview: { __typename?: 'ProductReview', id: string, createdAt: any, rating: number, summary: string, body: string, state: string, authorName: string } };

export type GetSiteSettingsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSiteSettingsQuery = { __typename?: 'Query', siteSettings: { __typename?: 'SiteSettings', underConstruction: boolean, countdownDate?: any | null } };

export type ActiveCustomerWishlistQueryVariables = Exact<{ [key: string]: never; }>;


export type ActiveCustomerWishlistQuery = { __typename?: 'Query', activeCustomerWishlist: Array<{ __typename?: 'WishlistItem', id: string, createdAt: any, productVariant: { __typename?: 'ProductVariant', id: string, name: string, price: any, currencyCode: CurrencyCode, product: { __typename?: 'Product', id: string, name: string, slug: string, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null } } }> };
...
export type AddToWishlistMutation = { __typename?: 'Mutation', addToWishlist: Array<{ __typename?: 'WishlistItem', id: string }> };
...
export type RemoveFromWishlistMutation = { __typename?: 'Mutation', removeFromWishlist: Array<{ __typename?: 'WishlistItem', id: string }> };

export const ExtendedOrderDetailFragmentDoc = gql`
...
export const ListedProductFragmentDoc = gql`
  ...
  productVariantId
    ...
    `;
export const ProductReviewFragmentDoc = gql`
...
export const AddPaymentToOrderDocument = gql`
  ...
  addPaymentToOrder(input: $input) {
    ...
    ${ExtendedOrderDetailFragmentDoc}`;
export const TransitionOrderToStateDocument = gql`
  ...
  transitionOrderToState(state: $state) {
    ...
    ${ExtendedOrderDetailFragmentDoc}`;
export const MidtransClientConfigDocument = gql`
  ...
  midtransClientConfig {
    ...
    `;
export const RajaOngkirSearchDestinationsDocument = gql`
  ...
  rajaOngkirSearchDestinations(search: $search, limit: $limit, offset: $offset) {
    ...
    `;
export const RajaOngkirCalculateShippingDocument = gql`
  ...
  rajaOngkirCalculateShipping(destinationId: $destinationId, weight: $weight) {
    ...
    `;
export const RajaOngkirAvailableCouriersDocument = gql`
  ...
  rajaOngkirAvailableCouriers {
    ...
    `;
export const MidtransTransactionStatusDocument = gql`
...
export const ActiveCustomerOrderListDocument = gql`
  ...
  activeCustomer {
    ...
    `;
export const GetActiveHomepageDataDocument = gql`
...
export const GetSiteSettingsDocument = gql`
  ...
  siteSettings {
    ...
    `;
export const ActiveCustomerWishlistDocument = gql`
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    ...
    midtransClientConfig(variables?: MidtransClientConfigQueryVariables, options?: C): Promise<MidtransClientConfigQuery> {
      return requester<MidtransClientConfigQuery, MidtransClientConfigQueryVariables>(MidtransClientConfigDocument, variables, options) as Promise<MidtransClientConfigQuery>;
    },
    rajaOngkirSearchDestinations(variables: RajaOngkirSearchDestinationsQueryVariables, options?: C): Promise<RajaOngkirSearchDestinationsQuery> {
      return requester<RajaOngkirSearchDestinationsQuery, RajaOngkirSearchDestinationsQueryVariables>(RajaOngkirSearchDestinationsDocument, variables, options) as Promise<RajaOngkirSearchDestinationsQuery>;
    },
    rajaOngkirCalculateShipping(variables: RajaOngkirCalculateShippingQueryVariables, options?: C): Promise<RajaOngkirCalculateShippingQuery> {
      return requester<RajaOngkirCalculateShippingQuery, RajaOngkirCalculateShippingQueryVariables>(RajaOngkirCalculateShippingDocument, variables, options) as Promise<RajaOngkirCalculateShippingQuery>;
    },
    rajaOngkirAvailableCouriers(variables?: RajaOngkirAvailableCouriersQueryVariables, options?: C): Promise<RajaOngkirAvailableCouriersQuery> {
      return requester<RajaOngkirAvailableCouriersQuery, RajaOngkirAvailableCouriersQueryVariables>(RajaOngkirAvailableCouriersDocument, variables, options) as Promise<RajaOngkirAvailableCouriersQuery>;
    },
    midtransTransactionStatus(variables: MidtransTransactionStatusQueryVariables, options?: C): Promise<MidtransTransactionStatusQuery> {
      return requester<MidtransTransactionStatusQuery, MidtransTransactionStatusQueryVariables>(MidtransTransactionStatusDocument, variables, options) as Promise<MidtransTransactionStatusQuery>;
    },
    ...
    getActiveHomepageData(variables?: GetActiveHomepageDataQueryVariables, options?: C): Promise<GetActiveHomepageDataQuery> {
      return requester<GetActiveHomepageDataQuery, GetActiveHomepageDataQueryVariables>(GetActiveHomepageDataDocument, variables, options) as Promise<GetActiveHomepageDataQuery>;
    },
    SubscribeToNewsletter(variables: SubscribeToNewsletterMutationVariables, options?: C): Promise<SubscribeToNewsletterMutation> {
      return requester<SubscribeToNewsletterMutation, SubscribeToNewsletterMutationVariables>(SubscribeToNewsletterDocument, variables, options) as Promise<SubscribeToNewsletterMutation>;
    },
    ...
    productReviews(variables: ProductReviewsQueryVariables, options?: C): Promise<ProductReviewsQuery> {
      return requester<ProductReviewsQuery, ProductReviewsQueryVariables>(ProductReviewsDocument, variables, options) as Promise<ProductReviewsQuery>;
    },
    submitReview(variables: SubmitReviewMutationVariables, options?: C): Promise<SubmitReviewMutation> {
      return requester<SubmitReviewMutation, SubmitReviewMutationVariables>(SubmitReviewDocument, variables, options) as Promise<SubmitReviewMutation>;
    },
    getSiteSettings(variables?: GetSiteSettingsQueryVariables, options?: C): Promise<GetSiteSettingsQuery> {
      return requester<GetSiteSettingsQuery, GetSiteSettingsQueryVariables>(GetSiteSettingsDocument, variables, options) as Promise<GetSiteSettingsQuery>;
    },
    activeCustomerWishlist(variables?: ActiveCustomerWishlistQueryVariables, options?: C): Promise<ActiveCustomerWishlistQuery> {
      return requester<ActiveCustomerWishlistQuery, ActiveCustomerWishlistQueryVariables>(ActiveCustomerWishlistDocument, variables, options) as Promise<ActiveCustomerWishlistQuery>;
    },
    addToWishlist(variables: AddToWishlistMutationVariables, options?: C): Promise<AddToWishlistMutation> {
      return requester<AddToWishlistMutation, AddToWishlistMutationVariables>(AddToWishlistDocument, variables, options) as Promise<AddToWishlistMutation>;
    },
    removeFromWishlist(variables: RemoveFromWishlistMutationVariables, options?: C): Promise<RemoveFromWishlistMutation> {
      return requester<RemoveFromWishlistMutation, RemoveFromWishlistMutationVariables>(RemoveFromWishlistDocument, variables, options) as Promise<RemoveFromWishlistMutation>;
    }
  };
}

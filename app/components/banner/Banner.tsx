            ...
            <div className="container mx-auto bg-karima-brand relative overflow-hidden shadow-2xl">
                ...
                <div className="flex flex-row items-center h-[200px] md:h-auto">
                    <div className="w-[60%] md:w-[70%] py-6 px-4 md:py-16 md:px-24 text-left z-10 flex flex-col justify-center h-full">
                        <h2 className="text-4xl md:text-8xl font-serif text-white italic mb-4 md:mb-6 leading-tight whitespace-nowrap">{title}</h2>
                        ...
                        <Link to={linkUrl} className="inline-block border border-white/40 text-white px-6 py-2 md:px-10 md:py-4 text-[10px] md:text-xs font-bold uppercase tracking-[0.25em] hover:bg-white hover:text-karima-brand transition-all duration-500 rounded-full w-fit">
                            SHOP NOW
                        </Link>
                    </div>
                    <div className="w-[40%] md:w-[60%] h-full md:h-[450px] absolute right-0 top-0 bottom-0 pointer-events-none md:relative">
                        ...
                        <img alt={title} className="w-full h-full object-cover object-center opacity-100 mix-blend-overlay md:opacity-100 md:mix-blend-normal" src={imageUrl} />
                    </div>
                </div>
            </div>
        </section>
